...
func CheckOtherPlayUrl(db *gorm.DB){
...
func CheckOthersPlayUrlByProvider(provider uint32,db *gorm.DB){
	...
	if err := db.Where("provider = ?",provider).First(&playUrl).Error ; err != nil{
		logger.Error(err)
		return
	}
	jsCode := GetJsCode()
	realUrl := service.GetRealUrl(playUrl.Provider,playUrl.Url,jsCode)
	if isCanPlay(realUrl){
		if err := db.Exec("update play_url set on_line = 1 where provider = ?",provider).Error ; err != nil{
			logger.Error(err)
			return
		}
		if err := db.Exec("update video a inner join episode b on a.id = b.video_id inner join play_url c on b.id = c.content_id and c.content_type = 2 set a.status = 2").Error ; err != nil{
			logger.Error(err)
			return
		}
	}else{
		if err := db.Exec("update play_url set on_line = 0 where provider = ?",provider).Error ; err != nil{
			logger.Error(err)
			return
		}
		if err := db.Exec("update video a inner join episode b on a.id = b.video_id inner join play_url c on b.id = c.content_id and c.content_type = 2 set a.status = 3").Error ; err != nil{
			logger.Error(err)
			return
		}
	}
...
func CheckSystemPlayUrl(db *gorm.DB){
	var err error
	...
	for _ , video := range videos{
		...
		if err = db.Where("video_id = ?",video.Id).Find(&episodes).Error ; err != nil{
			logger.Error(err)
			return
		}
		video.Status = 3
		for _ , episode := range episodes{
			...
			if err = db.Where("content_type = 2 and content_id = ?",episode.Id).Find(&playUrls).Error ; err != nil{
				logger.Error(err)
				return
			}

			for _, playUrl := range playUrls{
				if playUrl.Provider == 0 || playUrl.Provider == 10 || playUrl.Provider == 20{
					if isCanPlay(playUrl.Url){
						playUrl.OnLine = true
						video.Status = 2
					}else{
...
func isCanPlay(url string)(bool){
	return true
}
...
func GetJsCode()(string){
	...
	jsCode := "!function(a){\"use strict\";function b(a,b){var c=(65535&a)+(65535&b),d=(a>>16)+(b>>16)+(c>>16);return d<<16|65535&c}function c(a,b){return a<<b|a>>>32-b}function d(a,d,e,f,g,h){return b(c(b(b(d,a),b(f,h)),g),e)}function e(a,b,c,e,f,g,h){return d(b&c|~b&e,a,b,f,g,h)}function f(a,b,c,e,f,g,h){return d(b&e|c&~e,a,b,f,g,h)}function g(a,b,c,e,f,g,h){return d(b^c^e,a,b,f,g,h)}function h(a,b,c,e,f,g,h){return d(c^(b|~e),a,b,f,g,h)}function i(a,c){a[c>>5]|=128<<c%32,a[(c+64>>>9<<4)+14]=c;var d,i,j,k,l,m=1732584193,n=-271733879,o=-1732584194,p=271733878;for(d=0;d<a.length;d+=16)i=m,j=n,k=o,l=p,m=e(m,n,o,p,a[d],7,-680876936),p=e(p,m,n,o,a[d+1],12,-389564586),o=e(o,p,m,n,a[d+2],17,606105819),n=e(n,o,p,m,a[d+3],22,-1044525330),m=e(m,n,o,p,a[d+4],7,-176418897),p=e(p,m,n,o,a[d+5],12,1200080426),o=e(o,p,m,n,a[d+6],17,-1473231341),n=e(n,o,p,m,a[d+7],22,-45705983),m=e(m,n,o,p,a[d+8],7,1770035416),p=e(p,m,n,o,a[d+9],12,-1958414417),o=e(o,p,m,n,a[d+10],17,-42063),n=e(n,o,p,m,a[d+11],22,-1990404162),m=e(m,n,o,p,a[d+12],7,1804603682),p=e(p,m,n,o,a[d+13],12,-40341101),o=e(o,p,m,n,a[d+14],17,-1502002290),n=e(n,o,p,m,a[d+15],22,1236535329),m=f(m,n,o,p,a[d+1],5,-165796510),p=f(p,m,n,o,a[d+6],9,-1069501632),o=f(o,p,m,n,a[d+11],14,643717713),n=f(n,o,p,m,a[d],20,-373897302),m=f(m,n,o,p,a[d+5],5,-701558691),p=f(p,m,n,o,a[d+10],9,38016083),o=f(o,p,m,n,a[d+15],14,-660478335),n=f(n,o,p,m,a[d+4],20,-405537848),m=f(m,n,o,p,a[d+9],5,568446438),p=f(p,m,n,o,a[d+14],9,-1019803690),o=f(o,p,m,n,a[d+3],14,-187363961),n=f(n,o,p,m,a[d+8],20,1163531501),m=f(m,n,o,p,a[d+13],5,-1444681467),p=f(p,m,n,o,a[d+2],9,-51403784),o=f(o,p,m,n,a[d+7],14,1735328473),n=f(n,o,p,m,a[d+12],20,-1926607734),m=g(m,n,o,p,a[d+5],4,-378558),p=g(p,m,n,o,a[d+8],11,-2022574463),o=g(o,p,m,n,a[d+11],16,1839030562),n=g(n,o,p,m,a[d+14],23,-35309556),m=g(m,n,o,p,a[d+1],4,-1530992060),p=g(p,m,n,o,a[d+4],11,1272893353),o=g(o,p,m,n,a[d+7],16,-155497632),n=g(n,o,p,m,a[d+10],23,-1094730640),m=g(m,n,o,p,a[d+13],4,681279174),p=g(p,m,n,o,a[d],11,-358537222),o=g(o,p,m,n,a[d+3],16,-722521979),n=g(n,o,p,m,a[d+6],23,76029189),m=g(m,n,o,p,a[d+9],4,-640364487),p=g(p,m,n,o,a[d+12],11,-421815835),o=g(o,p,m,n,a[d+15],16,530742520),n=g(n,o,p,m,a[d+2],23,-995338651),m=h(m,n,o,p,a[d],6,-198630844),p=h(p,m,n,o,a[d+7],10,1126891415),o=h(o,p,m,n,a[d+14],15,-1416354905),n=h(n,o,p,m,a[d+5],21,-57434055),m=h(m,n,o,p,a[d+12],6,1700485571),p=h(p,m,n,o,a[d+3],10,-1894986606),o=h(o,p,m,n,a[d+10],15,-1051523),n=h(n,o,p,m,a[d+1],21,-2054922799),m=h(m,n,o,p,a[d+8],6,1873313359),p=h(p,m,n,o,a[d+15],10,-30611744),o=h(o,p,m,n,a[d+6],15,-1560198380),n=h(n,o,p,m,a[d+13],21,1309151649),m=h(m,n,o,p,a[d+4],6,-145523070),p=h(p,m,n,o,a[d+11],10,-1120210379),o=h(o,p,m,n,a[d+2],15,718787259),n=h(n,o,p,m,a[d+9],21,-343485551),m=b(m,i),n=b(n,j),o=b(o,k),p=b(p,l);return[m,n,o,p]}function j(a){var b,c=\"\";for(b=0;b<32*a.length;b+=8)c+=String.fromCharCode(a[b>>5]>>>b%32&255);return c}function k(a){var b,c=[];for(c[(a.length>>2)-1]=void 0,b=0;b<c.length;b+=1)c[b]=0;for(b=0;b<8*a.length;b+=8)c[b>>5]|=(255&a.charCodeAt(b/8))<<b%32;return c}function l(a){return j(i(k(a),8*a.length))}function m(a,b){var c,d,e=k(a),f=[],g=[];for(f[15]=g[15]=void 0,e.length>16&&(e=i(e,8*a.length)),c=0;16>c;c+=1)f[c]=909522486^e[c],g[c]=1549556828^e[c];return d=i(f.concat(k(b)),512+8*b.length),j(i(g.concat(d),640))}function n(a){var b,c,d=\"0123456789abcdef\",e=\"\";for(c=0;c<a.length;c+=1)b=a.charCodeAt(c),e+=d.charAt(b>>>4&15)+d.charAt(15&b);return e}function o(a){return unescape(encodeURIComponent(a))}function p(a){return l(o(a))}function q(a){return n(p(a))}function r(a,b){return m(o(a),o(b))}function s(a,b){return n(r(a,b))}function t(a,b,c){return b?c?r(b,a):s(b,a):c?p(a):q(a)}\"function\"==typeof define&&define.amd?define(function(){return t}):a.md5=t}(this);\n" +
		...
		"/*REPLACE_BEGIN*/\n" +
		"/**********替换部分的代码(CNTV)***********/\n" +
		"var _0x5b59=[\"\x6F\x77\x38\x32\x76\x63\x39\x32\x6B\x64\x38\x37\x76\x38\x32\x6B\x64\",\"\x70\x61\x72\x73\x65\",\"\x79\x33\x66\",\"\x30\",\"\x72\x61\x6E\x64\x6F\x6D\",\n" +
		"    \"\x66\x6C\x6F\x6F\x72\",\"\x2F\x63\x6E\x74\x76\x6C\x69\x76\x65\x2F\",\"\x6D\x64\x2E\x6D\x33\x75\x38\",\"\x2D\",\n" +
		"    \"\x66\x65\x39\x64\x75\x32\x38\x64\x6C\x76\x6E\x33\x38\x65\x64\x6A\x63\x75\x64\x66\",\"\x6C\x65\x6E\x67\x74\x68\",\"\x73\x75\x62\x73\x74\x72\x69\x6E\x67\",\n" +
		...
		"    \"\x31\",\"\x73\x72\x63\",\"\x5F\x68\x74\x6D\x6C\x35\x50\x6C\x61\x79\x65\x72\",\"\x68\x75\x61\x77\x65\x69\",\"\x69\x6E\x64\x65\x78\x4F\x66\",\n" +
		"    \"\x74\x6F\x4C\x6F\x77\x65\x72\x43\x61\x73\x65\",\"\x75\x73\x65\x72\x41\x67\x65\x6E\x74\",\"\x6C\x6F\x61\x64\",\"\x64\x69\x61\x6E\x70\x69\x61\x6E\x2E\x6D\x70\x34\",\n" +
		"    \"\x75\x6E\x64\x65\x66\x69\x6E\x65\x64\",\"\x70\x6F\x73\x74\x65\x72\",\"\x4C\x49\x56\x45\x2D\x48\x44\x53\x2D\x43\x44\x4E\x2D\x41\x4C\x49\"];\n" +
		"\n" +
		"function setFlvHtml5AliNewUrl(videoName) {\n" +
		"    var _0xec8cx3 = _0x5b59[0];\n" +
		"    var _0xec8cx4 = Date[_0x5b59[1]](new Date()) / 1000;\n" +
		"    _0xec8cx3 += _0x5b59[2];\n" +
		"    var _0xec8cx5 = _0x5b59[3];\n" +
		"    var _0xec8cx6 = Math[_0x5b59[5]](Math[_0x5b59[4]]() * 1000);\n" +
		"    var _0xec8cx7 = _0x5b59[6] + videoName + _0x5b59[7];\n" +
		"    var _0xeae7=[\"\x62\x76\x33\x65\"];\n" +
		"    var html5Aauth= \"\x30\x6C\";\n" +
		"    _0xeae7.push(\"\x73\x31\");\n" +
		"    html5Aauth += _0xeae7[0]+_0xeae7[1];\n" +
		"    var _0xec8cx8 = md5(_0xec8cx7 + _0x5b59[8] + _0xec8cx4 + _0x5b59[8] + _0xec8cx6 + _0x5b59[8] + _0xec8cx5 + _0x5b59[8] + _0x5b59[9][16] + html5Aauth + _0xec8cx3[_0x5b59[11]](_0xec8cx3[_0x5b59[10]] - 5));\n" +
		"    var _0xec8cx9 = _0xec8cx4 + _0x5b59[8] + _0xec8cx6 + _0x5b59[8] + _0xec8cx5 + _0x5b59[8] + _0xec8cx8;\n" +
		"    return _0x5b59[12] + _0xec8cx7 + _0x5b59[13] + _0xec8cx9;\n" +
		"\n" +
		"}\n" +
		"/*REPLACE_END*/\n" +
		"\n" +
		...
		"            if(json_data.times === 1){\n" +
		"                var param = json_data.channel.split(\"|\")\n" +
		"                fetch_url_new.url = \"http://apis-live.iqiyi.com/live/stream/get.json\";\n" +
		"\n" +
		"                fetch_url_new.header = {\"Content-Type\":\"application/x-www-form-urlencode\"};\n" +
		"                //fetch_url_new.body = \"\\\"tl\\\":\\\"pcw\\\"|\\\"mixUpKey\\\":\\\"\" + param[0] + \"\\\"|\\\"sn\\\":\\\"\" + param[2] + \"\\\"|\\\"deviceId\\\":\\\"747846c2bc7dacd0015d6623cc9047fd\\\"|\\\"protocol\\\":8|\\\"anchorId\\\":\\\"\" + param[1] + \"\\\"|\\\"platform\\\":\\\"1_10_101_1021\\\"|\\\"userId\\\":0|\\\"authCookie\\\":\\\"\\\"|\\\"onlyStream\\\":0|\\\"ua\\\":\\\"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36\\\"|\\\"bitRateType\\\":\\\"\\\"|\\\"version\\\":\\\"01.04.2701\\\"\";\n" +
		"                fetch_url_new.body = {\n" +
		"                    \"tl\":\"pcw\",\n" +
		"                    \"mixUpKey\":param[0],\n" +
		"                    \"sn\":param[2],\n" +
		"                    \"deviceId\":\"747846c2bc7dacd0015d6623cc9047fd\",\n" +
		"                    \"protocol\":8,\n" +
		"                    \"anchorId\":param[1],\n" +
		...
		"\n" +
		"            //hcdnlive://BUAAAAFXHWZDKQI7HXYIWZKBD5Z3MRY7IEPXAEIBBJAR6ZPDBYXUCH3XKRHGGQI7OTJ3ZD2BD7JZPEIUIEPXPPDOEFAR6554NYPUCH3F4PETIQI7OHHVUFSBD5Y46WQVIEPQOAAAABS6GDRNFYLNUPDFGQXBM36OBULC4FWTS6ISWLQW3WZ36EZOCZZ3MRY7FYLLOPNS5UXBM?hl_nm=6&hl_cid=4PJ4EZI7NLJWR3I3RX3AANN5VP4QEWLQ&hl_slid=c43_qlive_rqy_z24xbjka_s10&hl_slst=10&hl_cp=3&hl_dl=0&hl_dls=50&hl_dle=120&hl_apptp=qlive&hl_stapp=liveugc&hl_stid=rqy_z24xbjka&hl_sttp=flv&hl_stft=flv&hl_pltp=1&hl_stpr=rtmp&hl_stpt=1935&hl_dp=NB2HI4B2F4XWM3DWNRUXMZJOOZUWIZLPFZUXC2LZNEXGG33NF4&hl_force=0&qd_vip=&qd_p=111.175.50.36&qd_tm=1527064164079&qd_uid=0&file_name=c43_qlive_rqy_z24xbjka_s10&ip=111.175.50.36&qd_src=01014351010000000000&qd_k=&qd_sc=4cdd5eefb0139362e20eaf3085301d71\n" +
		"\n" +
		"            var surl = response.data.hcdnlive;\n" +
		"            var param = surl.slice(surl.indexOf(\"?\"));\n" +
		"            var file_name = surl.slice(surl.indexOf(\"file_name=\") + 10);\n" +
		"            file_name = file_name.slice(0,file_name.indexOf(\"&\"));\n" +
		"            fetch_url_new.url = \"http://flvlive.video.iqiyi.com/liveugc/\" + file_name + \".flv\" + param;\n" +
		"            fetch_url_new.method = \"get\";\n" +
		"            result.done = false;\n" +
		"        }else if (json_data.times === 3){\n" +
		"            var data = json_data.html_data;\n" +
		"\n" +
		...
		"            var uus = response.l;\n" +
		"\n" +
		"            var host = u.slice(0,u.indexOf(\"/liveugc/\"));\n" +
		"            var param = u.slice(u.indexOf(\"?\"))\n" +
		"            var tfile = u.slice(u.indexOf(\"/liveugc/\") + 9,u.indexOf(\"?\"));\n" +
		"            var zui = tfile.slice(tfile.indexOf(\".\"))\n" +
		"            var fs = tfile.split(\"_\")\n" +
		"            var file_name = fs[2] + \"_\" + fs[3] + zui\n" +
		"            var port;\n" +
		"            if(host.indexOf(\"https:\") > -1){\n" +
		"                port = response.p.https;\n" +
		"            }else if(host.indexOf(\"http:\") > -1){\n" +
		"                port = response.p.http;\n" +
		"            }else if(host.indexOf(\"rtmp:\") > -1){\n" +
		"                port = response.p.rtmp;\n" +
		"            }else if(host.indexOf(\"hts:\") > -1){\n" +
		"                port = response.p.hts;\n" +
		"            }\n" +
		"\n" +
		"            var real_url = host + \":\" + port + \"/liveugc/\" + file_name + param;\n" +
		"\n" +
		"            fetch_url_new.url = \"\";\n" +
		"            fetch_url = fetch_url_new.url;\n" +
		"            result.done = true;\n" +
