...
func main(){
	...
	playUrl.Url = "http://www.mgtv.com/b/319142/4159960.html"
	playUrl.Channel = playUrl.Url
	playUrl.Quality = 4
	playUrl.TvType = "卫视"
	playUrl.Times = 0
	playUrl.ContentType = 2
	realUrl := GetStreamSourceUrl1(playUrl)
	logger.Debug(realUrl)
}



func GetStreamSourceUrl1(v OtherPlayUrl)(string){
	if v.Provider == 0 {
		return v.Url
	}
	var err error
