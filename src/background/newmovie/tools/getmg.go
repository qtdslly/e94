...
func FilterMgMovieInfo(document *goquery.Document,db *gorm.DB)(){
	...
	movieDoc.Each(func(i int, s *goquery.Selection) {
		...
		tmp := strings.Replace(url,"https://www.mgtv.com/b/","",-1)
		...
		data = strings.Replace(data,"jQuery18204076358277541021_1528805935312(","",-1)
